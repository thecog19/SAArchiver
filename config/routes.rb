Rails.application.routes.draw do
  ...
  get '/posts/byuser/:user_id/', to: 'posts#posts_by_user'
  ...
  get '/all_threads', to: 'sathread#all_threads'
  get '/posts/user/:user_id/:search_type/:search_term', to: "posts#search_user_posts"
  get '/posts/search/:search_type/:search_term', to: "posts#search_posts"
